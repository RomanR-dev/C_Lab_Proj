...
misc = misc/definitions.h misc/parsers.h misc/parsers.c misc/utils.h misc/utils.c
...
dotCfiles =  misc/parsers.c misc/utils.c passes/first_pass.c passes/second_pass.c passes/pre_assembler.c
